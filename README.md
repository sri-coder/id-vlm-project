...
## Status
In progress — data pipeline working, training in progress on Colab.
...
## Why
[HyperVerge/whoever]'s JD explicitly asks for people who train and 
fine-tune models, not just call APIs — this is me doing that.
